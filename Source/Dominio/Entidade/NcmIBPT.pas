...
type
  ...
  public
    ...
    property cfop                  :TCFOP read getCFOP;
end;
...
function TNcmIBPT.getCFOP: TCFOP;
...
begin
  try
    ...
    begin
      ...
      FCFOP        := TCFOP(repositorio.Get(codigo_cfop));
    end;
