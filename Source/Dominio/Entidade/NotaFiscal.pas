...
type
  ...
  private
    ...
    procedure SetNaturezaOperacao(N :TCFOP);
  ...
  public
    ...
    property CFOP             :TCFOP                   read GetNatureza          write SetNaturezaOperacao;
...
//  Item,
  ...
  EspecificacaoItensDaNotaFiscal, Funcoes,
...
procedure TNotaFiscal.SetNaturezaOperacao(N: TCFOP);
begin
...
constructor TNotaFiscal.Create(Natureza: TCFOP; Serie: String; Emitente, Destinatario: TPessoa; const Entrada :Boolean);
var
...
function TNotaFiscal.GetNatureza: TCFOP;
var
  Repositorio :TRepositorio;
begin
   if not Assigned(self.FNatureza) then begin
     ...
     try
       ...
       self.FNatureza       := (Repositorio.Get(self.FcodigoNatureza) as TCFOP);
