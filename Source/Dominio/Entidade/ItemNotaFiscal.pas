...
type
  ...
  private
    ...
    function GetNaturezaOperacao       :TCFOP;
 ...
 //   procedure AdicionarBuscadorCodigoNotaFiscal     (Buscador :TMetodoDelegadoObtemCampoInteger);
  ...
  public
    ...
    property NaturezaOperacao     :TCFOP             read GetNaturezaOperacao       write FNaturezaOperacao;
...
constructor TItemNotaFiscal.CriaLucroPresumido(Produto: TProduto;
  NaturezaOperacao: TCFOP; Quantidade, ValorUnitario :Real;
  OrigemMercadoria: TTipoOrigemMercadoria;
...
function TItemNotaFiscal.GetNaturezaOperacao: TCFOP;
var
  Repositorio :TRepositorio;
begin
   Repositorio := nil;
   ...
   if not Assigned(self.FNaturezaOperacao) then begin
     try
       ...
       self.FNaturezaOperacao := (Repositorio.Get(self.FCodigoNaturezaOperacao) as TCFOP);
     finally
       FreeAndNil(Repositorio);
     end;
   end;
