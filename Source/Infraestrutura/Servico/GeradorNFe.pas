...
begin
  ...
  if not stringVazia(ConfiguracoesNF.senha_certificado) then
...
var
  DhEvento  :TDateTime;
begin
   if (stringVazia(Justificativa)) then
...
begin
   ...
   icms_partilha      := 0;
     ...
     for nX := 0 to (Itens.Count-1) do begin
        ...
        ItemNFe.Prod.uTrib    := Item.Produto.unidade_medida;
...
begin
  ...
  nfe.NFe.Dest.EnderDest.xLgr    := NF.Destinatario.Endereco.Logradouro;
  nfe.NFe.Dest.EnderDest.cPais   := 1058;
  nfe.NFe.Dest.EnderDest.xPais   := 'BRASIL';
  nfe.NFe.Dest.EnderDest.nro     := NF.Destinatario.Endereco.Numero;
  nfe.NFe.Dest.EnderDest.xBairro := NF.Destinatario.Endereco.Bairro;
  nfe.NFe.Dest.EnderDest.cMun    := NF.Destinatario.Endereco.Cidade.codibge;
  nfe.NFe.Dest.EnderDest.xMun    := NF.Destinatario.Endereco.Cidade.nome;
  nfe.NFe.Dest.EnderDest.UF      := NF.Destinatario.Endereco.Cidade.Estado.sigla;
  nfe.NFe.Dest.EnderDest.CEP     := StrToIntDef(ApenasNumeros(NF.Destinatario.Endereco.cep),0);
...
begin
  ...
  nfe.NFe.Emit.EnderEmit.xLgr    := NF.Emitente.Endereco.Logradouro;
  nfe.NFe.Emit.EnderEmit.nro     := NF.Emitente.Endereco.Numero;
  nfe.NFe.Emit.EnderEmit.xBairro := NF.Emitente.Endereco.Bairro;
  nfe.NFe.Emit.EnderEmit.cMun    := NF.Emitente.Endereco.Cidade.codibge;
  nfe.NFe.Ide.cMunFG             := NF.Emitente.Endereco.Cidade.codibge;
  nfe.NFe.Emit.EnderEmit.xMun    := NF.Emitente.Endereco.Cidade.nome;
  nfe.NFe.Emit.EnderEmit.UF      := NF.Emitente.Endereco.Cidade.Estado.sigla;
...
begin
  ...
  nfe.NFe.Transp.Transporta.xEnder  := NF.Transportadora.Endereco.Logradouro;
  nfe.NFe.Transp.Transporta.xMun    := NF.Transportadora.Endereco.Cidade.nome;
  nfe.NFe.Transp.Transporta.UF      := NF.Transportadora.Endereco.Cidade.Estado.sigla;
end;
...
begin
   ...
   if not stringVazia(CaminhoLogo) then
