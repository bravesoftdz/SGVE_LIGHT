inherited frmRelatorioNFCes: TfrmRelatorioNFCes
  ...
  object qryNFCe: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select nfce.nr_nota, nfce.codigo_pedido, nfce.status, nfce.motiv' +
        'o, nfce.chave, ped.valor_total,  nfce.XML,'
      
        '       CAST(nfce.dh_recebimento as DATE) data, pro.descricao pro' +
        'duto, ibpt.ncm_ibpt, i.quantidade'
      ''
      '   from NFCE'
      ''
      ...
      '          extract(month from nfce.dh_recebimento) = :mes)'
      '     and (NFCE.STATUS in ('#39'100'#39'))'
      ''
    ...
    object qryNFCeNR_NOTA: TIntegerField
      FieldName = 'NR_NOTA'
      Origin = 'NR_NOTA'
    end
    object qryNFCeCODIGO_PEDIDO: TIntegerField
      FieldName = 'CODIGO_PEDIDO'
      Origin = 'CODIGO_PEDIDO'
    end
    object qryNFCeSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      FixedChar = True
      Size = 3
    end
    object qryNFCeMOTIVO: TStringField
      FieldName = 'MOTIVO'
      Origin = 'MOTIVO'
      Size = 150
    end
    ...
    object qryNFCeVALOR_TOTAL: TBCDField
    ...
    object qryNFCePRODUTO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PRODUTO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryNFCeNCM_IBPT: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NCM_IBPT'
      Origin = 'NCM_IBPT'
      ProviderFlags = []
    ...
    object qryNFCeQUANTIDADE: TBCDField
      AutoGenerateValue = arDefault
