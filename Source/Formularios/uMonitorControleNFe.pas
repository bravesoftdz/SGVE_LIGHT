...
begin
   ...
   try
     ...
     if HouveErros then begin
       ...
       avisar(1, IfThen(notasComRejeicao <> '', notasComRejeicao, 'Nota(s) enviada(s) com sucesso!'),2);
     end;
...
begin
   ...
   try
     Justificativa              := inputBox('Digite a justificativa. (Se não digitar a justificativa será: CANCELAMENTO DE NF-E)');
     RepositorioNotaFiscal      := TFabricaRepositorio.GetRepositorio(TNotaFiscal.ClassName);
     ...
     if HouveErros then begin
       ...
       dm.conexao.Commit;
       avisar(1,'Nota cancelada com sucesso!',2);
     end;
