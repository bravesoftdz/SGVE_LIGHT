...
uses
  ...
  Dialogs, uPadrao, StdCtrls, Buttons{, TipoBanco, IBServices};
...
type
  ...
  public
    constructor Create(InicioDaAplicacao :Boolean = false);
...
constructor TfrmConfiguraBancoDeDados.Create(InicioDaAplicacao :Boolean = false);
const
...
begin
  ...
  if self.FInicioDaAplicacao then
    inherited Avisar(0,'Não foi possível conectar no banco de dados! Configure corretamente o banco!');
