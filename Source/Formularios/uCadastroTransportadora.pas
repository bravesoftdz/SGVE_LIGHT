...
uses Pessoa, Transportadora, repositorio, fabricaRepositorio, funcoes;
...
begin
  ...
  self.cdsFANTASIA.AsString     := Transportadora.nome_fantasia;
  self.cdsCPF_CNPJ.AsString     := Transportadora.cpf_cnpj;
  self.cdsENDERECO.AsString     := Transportadora.Endereco.logradouro + ', '+ Transportadora.Endereco.numero;
  self.cdsCIDADE.AsString       := Transportadora.Endereco.Cidade.nome + ' / '+Transportadora.Endereco.Cidade.Estado.sigla;
...
begin
   ...
   try
     ...
     Transportadora.nome_fantasia          := edtFantasia.Text;
     ...
     { Endereço }
     Transportadora.adicionaEndereco(edtLogradouro.Text,
                              edtNumero.Text,
                              edtBairro.Text,
                              edtCEP.Text,
                              edtComplento.Text,
...
begin
  ...
  if assigned(Transportadora.Endereco) then
  begin
    self.cdsENDERECO.AsString     := Transportadora.Endereco.logradouro + ', '+ Transportadora.Endereco.numero;
    self.cdsCIDADE.AsString       := Transportadora.Endereco.Cidade.nome + ' / '+Transportadora.Endereco.Cidade.Estado.sigla;
  end;
...
begin
  ...
  try
    ...
    edtFantasia.Text            := Transportadora.nome_fantasia;
    ...
    if Assigned(Transportadora.Endereco) then
    begin
      edtCodigoEndereco.AsInteger  := Transportadora.Endereco.codigo;
      edtLogradouro.Text           := Transportadora.Endereco.logradouro;
      edtNumero.Text               := Transportadora.Endereco.numero;
      edtBairro.Text               := Transportadora.Endereco.bairro;
      edtCEP.Text                  := Transportadora.Endereco.cep;
      BuscaCidade1.codigo          := Transportadora.Endereco.codcidade;
      edtComplento.Text            := Transportadora.Endereco.complemento;
    end;
